...
-- Tiempo de generación: 29-03-2022 a las 03:22:24
...
CREATE TABLE `pedidos` (
  `NÚMERO DE PEDIDO` smallint DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `productos- pedidos`
--

CREATE TABLE `productos- pedidos` (
  `NÚMERO DE PEDIDO` tinyint DEFAULT NULL,
  `CÓDIGO ARTÍCULO` varchar(4) DEFAULT NULL,
  `UNIDADES` tinyint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Volcado de datos para la tabla `productos- pedidos`
--
...
CREATE TABLE `productosnuevos` (
  ...
  `FECHA` varchar(19) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
