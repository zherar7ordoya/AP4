...
namespace AirportBaggageClaimInformationSystem
{
    public class ArrivalsMonitor : IObserver<BaggageInfo>
    {
        ...
        public virtual void Subscribe(BaggageHandler provider) => cancellation = provider.Subscribe(this);
        ...
        public virtual void OnCompleted() => flightInfos.Clear();
        ...
        public virtual void OnNext(BaggageInfo info)
        {
            ...
            if (info.Carousel == 0)
            {
                ...
                foreach (var flightToRemove in flightsToRemove) flightInfos.Remove(flightToRemove);
            ...
            {
                flightInfos.Sort();
                WriteLine("Arrivals information from {0}", this.name);
                foreach (var flightInfo in flightInfos) WriteLine(flightInfo);
                WriteLine();
            }
        }
    }
