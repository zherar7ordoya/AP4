...
-- Last modification date: 2022-04-29 14:41:00.772
...
CREATE TABLE BLOQUES (
    ...
    CONSTRAINT BLOQUES_ak UNIQUE (numero, id_cuestionario) NOT DEFERRABLE  INITIALLY IMMEDIATE,
...
CREATE TABLE PREGUNTAS (
    ...
    numero int  NOT NULL,
    texto text  NOT NULL,
    CONSTRAINT PREGUNTAS_ak UNIQUE (numero, id_bloque) NOT DEFERRABLE  INITIALLY IMMEDIATE,
...
CREATE TABLE USUARIOS (
    ...
    colectivo varchar(50)  NOT NULL,
    CONSTRAINT USUARIOS_ak UNIQUE (login) NOT DEFERRABLE  INITIALLY IMMEDIATE,
